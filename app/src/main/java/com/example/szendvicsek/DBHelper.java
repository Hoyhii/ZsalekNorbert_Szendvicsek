    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String sql = "CREATE TABLE "+TABLE_NAME +
                    " ("+COL_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "+ COL_NEV +
                    " TEXT NOT NULL, "+ COL_LEIRAS + " TEXT NOT NULL, "+
                    COL_ELKESZITES + " INTEGER NOT NULL, "+ COL_AR +
                    " INTEGER NOT NULL );";
            db.execSQL(sql);
        }
        ...
        public boolean rogzites(String nev, String leiras, String elkeszites, String ar){
        ...
        public Cursor listaz(){
            ...
            return db.query(TABLE_NAME, new String[]{COL_NEV,COL_LEIRAS,COL_ELKESZITES,COL_AR},
